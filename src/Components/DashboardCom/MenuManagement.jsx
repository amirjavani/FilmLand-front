                        ...
                        <thead className="text-xs text-gray-900  border-b border-neutral-500">
                                <tr>
                                    ...
                                    <th scope="col" className="w-10 text-center">
                                        <button onClick={()=>navigate('/dashboard/menuManagement/add')} className='bi bi-plus btn btn-success'>  </button>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
...
function AddObject() {
  const navigate = useNavigate()
    ...
    <form>
      ...
      <input type='text' className=''></input>
      <input type='text' className=''></input>
      <button className='btn btn-danger' onClick={()=>navigate('/dashboard/menuManagement')}> cancel</button>
    </form>
  )
}
